...
namespace Redcode.Pools
{
    ...
    public class PoolManager : MonoBehaviour
    {
        ...
        private List<IPool<Component>> _poolsObjects = new();
        ...
        //added
        public int GetPoolNums() => _poolsObjects.Count;
        public int GetPoolIndex(string poolName) => _pools.FindIndex(p => p.Name == poolName);
